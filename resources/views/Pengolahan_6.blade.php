...
<body class="min-h-screen flex flex-col">
    ...
    <main class="content flex-grow mb-5 mt-4 pt-28 px-12 mx-24">
        <h2 class="text-xl font-semibold text-black mb-4">Tabel 3 itemset</h2>


        <div class="bg-[#D9D9D9] p-4 w-full h-96 flex flex-col items-start">

            <h2 class="text-xl text-black mb-4 text-left">
                Berikut hasil dari 3 itemset yang memiliki nilai support diatas nilai minimum support
            </h2>
            <h2 class="text-xl  text-black mb-4 text-left">
                Min Support : { }
            </h2>
    ...
    <button
        ...
        onclick="window.location.href='/Pengolahan_7'">
        NEXT
    </button>
